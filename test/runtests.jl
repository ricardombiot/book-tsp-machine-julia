...
@time @testset "Machine" begin
    ...
    @testset "Hamiltonian" begin
        #include("machine/hamiltonian/test_grafo_complete_sizes.jl")
        #include("machine/hamiltonian/test_grafo_complete_max_stages.jl")
        #include("machine/hamiltonian/test_reading_step_by_step_forbook")

        include("machine/hamiltonian/test_grafo_example_book.jl")
    ...
    @testset "TSPBruteForce" begin
        ...
        #include("machine/tsp_brute_force/test_hal_brute_force.jl")
    end
